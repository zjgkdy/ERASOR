...
namespace erasor
{
        ...
        private:
                ...
                pcl::PointCloud<pcl::PointXYZI>::Ptr map_arranged_; // 子地图
                pcl::PointCloud<pcl::PointXYZI>::Ptr map_arranged_init_;
                pcl::PointCloud<pcl::PointXYZI>::Ptr map_arranged_global_;     // 全局地图 = 子地图 + 互补地图
                pcl::PointCloud<pcl::PointXYZI>::Ptr map_arranged_complement_; // 互补地图
                pcl::PointCloud<pcl::PointXYZI>::Ptr map_ceilings_;            // 天花板地图云
