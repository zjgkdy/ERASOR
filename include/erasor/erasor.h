...
// COLORS:
// 0 -> BLUE
#define MAP_IS_HIGHER 0.5  // GREEN
#define CURR_IS_HIGHER 1.0 // RED
#define LITTLE_NUM 0.0     // BLUE
#define BLOCKED 0.8        // 褐色：附近存在动态障碍物
#define MERGE_BINS 0.25    // 青色
#define NOT_ASSIGNED 0.0   // BLUE
// ground params
